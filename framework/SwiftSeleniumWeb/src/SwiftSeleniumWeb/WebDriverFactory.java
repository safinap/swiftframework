...
public class WebDriverFactory {
	...
	public WebDriverFactory() {
		...
		// 'CHROME_DRIVER' env variable has to be set in the system or in the jenkins job
	...
	/*private boolean isFirefoxExtensionsEnabled() {
		String extensionsEnabled = System.getProperty("firefoxExtensions", "false");
		return "TRUE".equals(extensionsEnabled.toUpperCase());
	}*/
